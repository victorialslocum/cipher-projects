...
def index():
    ...
    keyphrase = request.args.get("keyphrase", "")

    if plaintext and keyphrase:
        binary = binary_from(plaintext, keyphrase)
    else:
        binary = ""
